...
REG_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
...
CREATE TABLE  CUST_ACCT_TYPE(
UCI INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 1000000000000001,
REG_ID INT,
CUST_ACCT_NUM INT,
...
BNFCRY_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
CUST_ACCT_NUM INT,
BNFCRY_ACCT_NUM INT,
...
CREATED_DT DATE
FOREIGN KEY (CUST_ACCT_NUM) REFERENCES CUST_ACCT_TYPE(CUST_ACCT_NUM)
);

CREATE TABLE CUST_ACCT_TXN_INFO(
TXN_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
CUST_ACCT_NUM INT,
CUST_ACCT_TYPE VARCHAR(20),
TXN_TYPE VARCHAR(10),
FROM_ACCT_NUM INT,
...
CARD_REQ_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
...
CARD_NUM INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111, 
CARD_TYPE VARCHAR(10),
...
CARD_TXN_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111, 
CARD_NUM INT,
...
LOAN_REQ_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
...
LOAN_NUM INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
LOAN_REQ_ID INT, 
...
LOAN_EMI_PAYMENT INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
LOAN_NUM INT,
...
SERVICE_PROVIDER_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
...
LOGIN_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
LOGIN_TYPE VARCHAR(20),
LOGIN PWD VARCHAR(20),
TXN_PWD VARCHAR(20),
...
INTEREST_ID INT NOT NULL PRIMARY KEY AUTO_INCREMENT = 111,
